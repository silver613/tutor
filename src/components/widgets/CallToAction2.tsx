      ...
      <div className="mt-2">
        <form className="rounded-md border border-gray-400 bg-white shadow-md">
          <div className="flex items-center">
            {form.icon && (
              <span className="rounded-bl rounded-tl border-r-[1px] border-gray-400 px-2 py-2">
                <form.icon className="h-6 w-6 text-primary-600" />
              </span>
            )}
            <input
              ...
              className="w-full py-2 pl-2 pr-4 bg-white"
            />
            <button
              type={form.btn.type}
