	...
	return (
		<>
			<Paper className="rounded-lg p-2 py-4 md:py-8 lg:m-4">
				<Typography className="mb-1 text-center text-lg font-bold md:mb-3 md:text-2xl">Check Availability</Typography>
				...
				<Button variant='outlined' className='mx-auto w-fit block mt-4 hover:bg-primary-600 hover:text-white'>Schedule Lesson</Button>
			</Paper>
		</>
	);
}
